...
<div class="daftar-foto">
    ...
    // Mengambil daftar album yang memiliki foto
    $sql_album = mysqli_query($conn, "SELECT DISTINCT album.* 
                                      FROM album 
                                      INNER JOIN foto ON album.albumid = foto.albumid");
    ...
    ?>
            <div class="card">
                ...
                <a href="berandafoto-user.php?albumid=<?= $album_id ?>" class="next-button">More</a>
            </div>
        <?php
        } else {
