...
<div class="daftar-foto">
        ...
        ?>
                ...
                <ul class="card-list">
                    <li class="card">
                        <a href="javascript:void(0)" onclick="tampilkanModal('gambar/<?= $data['lokasifile'] ?>')">
                            <img src="gambar/<?= $data['lokasifile'] ?>" alt="<?= $data['judulfoto'] ?>" />
                        </a>

                        <a class="card-description" href="javascript:void(0)" onclick="tampilkanModal('gambar/<?= $data['lokasifile'] ?>')">
                        ...
                        <div class="button">
                            <div class="like">
                                <a href="like.php?fotoid=<?= $data['fotoid'] ?>&albumid=<?= $data['albumid'] ?>">Like</a>
                                <?php
                                $fotoid = $data['fotoid'];
...
<div class="modal" id="gambarModal">
        <span class="tutup" onclick="tutupModal()">&times;</span>
        <img class="modal-content" id="gambarModalContent" src="" alt="Gambar Detail">
    </div>
